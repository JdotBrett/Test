...
/****** Object:  Database [Clients]    Script Date: 10/10/2017 13:20:03 ******/
CREATE DATABASE [Clients]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Clients', FILENAME = N'D:\Program Files\Microsoft SQL Server\MSSQL13.SQLEXPRESS\MSSQL\DATA\Clients.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Clients_log', FILENAME = N'D:\Program Files\Microsoft SQL Server\MSSQL13.SQLEXPRESS\MSSQL\DATA\Clients_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [Clients] SET COMPATIBILITY_LEVEL = 130
GO
